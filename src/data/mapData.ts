...
export const MAP_LOCATIONS: MapLocation[] = [
  ...
  { id: 'sinai', name: 'Mount Sinai', lat: 28.5392, lng: 33.9747, note: 'Moses received the Ten Commandments here.', era: 'Exodus & Wilderness' },
  { id: 'red-sea', name: 'Red Sea Crossing', lat: 27.9844, lng: 33.8117, note: 'Israel crossed by God\'s power.', era: 'Exodus & Wilderness' },
  { id: 'kadesh', name: 'Kadesh-Barnea', lat: 30.5583, lng: 34.5417, note: 'Israel camped 38 years in the wilderness.', era: 'Exodus & Wilderness' },
  { id: 'jericho', name: 'Jericho', lat: 31.8669, lng: 35.4572, note: 'First city conquered by Joshua.', era: 'Exodus & Wilderness' },
  { id: 'shiloh', name: 'Shiloh', lat: 32.0617, lng: 35.2833, note: 'Tabernacle rested here for centuries.', era: 'Exodus & Wilderness' },
  ...
  { id: 'nineveh', name: 'Nineveh', lat: 36.3497, lng: 43.1561, note: 'Jonah preached to this Assyrian capital.', era: 'Divided Kingdom' },
  { id: 'babylon', name: 'Babylon', lat: 32.5422, lng: 44.4228, note: 'Judah spent 70 years in exile here.', era: 'Exile & Return' },
  { id: 'susa', name: 'Susa', lat: 32.1947, lng: 48.2578, note: 'Esther and Daniel served in this Persian capital.', era: 'Exile & Return' },
  { id: 'ezra-jerusalem', name: 'Jerusalem (Restoration)', lat: 31.7683, lng: 35.2133, note: 'Ezra and Nehemiah rebuilt the walls and temple.', era: 'Exile & Return' },
  ...
  { id: 'antioch', name: 'Antioch', lat: 36.2066, lng: 36.1572, note: 'First Gentile church and Paul\'s base.', era: 'Apostolic & Revelation' },
  { id: 'damascus', name: 'Damascus', lat: 33.5138, lng: 36.2765, note: 'Paul met the risen Christ on this road.', era: 'Apostolic & Revelation' },
  { id: 'rome', name: 'Rome', lat: 41.9028, lng: 12.4964, note: 'Paul wrote epistles under house arrest here.', era: 'Apostolic & Revelation' },
  { id: 'ephesus', name: 'Ephesus', lat: 37.9394, lng: 27.3417, note: 'A major center of early Christianity.', era: 'Apostolic & Revelation' },
  { id: 'corinth', name: 'Corinth', lat: 37.9380, lng: 22.9709, note: 'Paul established a church here.', era: 'Apostolic & Revelation' },
  { id: 'patmos', name: 'Patmos', lat: 37.3310, lng: 26.5460, note: 'John received the Revelation here.', era: 'Apostolic & Revelation' },
];
...
export const JOURNEY_ROUTES: JourneyRoute[] = [
  ...
  { id: 'exodus', name: 'The Exodus', locationIds: ['egypt', 'red-sea', 'sinai', 'kadesh', 'jericho'], color: '#8B6914', era: 'Exodus & Wilderness' },
  { id: 'paul-first', name: 'Paul\'s First Mission', locationIds: ['antioch', 'damascus', 'jerusalem'], color: '#6B4226', era: 'Apostolic & Revelation' },
